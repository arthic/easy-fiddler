...
function EasyFiddler() {
  ...
  return (
    <div className="App">
      <svg className="animate__animated animate__fadeInDown" xmlns="http://www.w3.org/2000/svg" width="18px" height="60" viewBox="0 0 49 60.3">
        <path
          fill="#5ce500"
      ...
      <div className="app-content animate__animated animate__fadeIn">
        <h1>Easy Fiddler</h1>
        <AddRegex />
      </div>
    </div>
